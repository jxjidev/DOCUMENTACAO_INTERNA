...
\
\
**Request de Assessment** já alterado o NamesSpace.\
DEVK925264 \[QADEVOPS] - Assessment new V1\
\
Foi atualizado o Namespace do Assessment nesse caso será transportado\
Será transportado para o cliente a request de cópia

Os Pacotes que serão transportados\
/QADEVOPS/ASSESSMENT\
/QADEVOPS/GLOBAL

Os pacotes deverão ser analisados a versão do cliente e depois gerado uma request com os objetos de SCI para não ter impacto direto no cliente.\
/QADEVOPS/SCI
